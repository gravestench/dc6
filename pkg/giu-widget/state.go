...
//)
//
//// state represents dc6 viewer's state
//type state struct {
//	viewerState
//	tiledState
//	mode widgetMode
...
//}
//
//func (w *state) Dispose() {
//	w.viewerState.Dispose()
//	w.mode = dc6WidgetViewer
//	w.textures = nil
//}
//
//func (w *state) Encode() []byte {
...
//}
//
//func (p *widget) runPlayer(state *state) {
...
//}
//
//func (p *widget) recalculateTiledViewWidth(state *state) {
...
//}
//
//func (p *widget) recalculateTiledViewHeight(state *state) {
//	// the area of our rectangle must be less or equal than FramesPerDirection
//	state.height = int32(p.dc6.FramesPerDirection) / state.width
//	p.createImage(state)
//}
//
//func (p *widget) createImage(state *state) {
