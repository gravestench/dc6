...
//func Create(state []byte, id string, dc6 *dc6.DC6) giu.Widget {
//	result := &widget{
//		id:  id,
//		dc6: dc6,
//	}
...
//}
//
//func (p *widget) makePlayerLayout(state *state) giu.Layout {
...
//}
//
//func (p *widget) makeTiledViewLayout(state *state) giu.Layout {
//	return giu.Layout{
//		giu.Row(
...
//}
//
//func (p *widget) exportGif(state *state) error {
